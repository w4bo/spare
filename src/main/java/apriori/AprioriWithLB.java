...
/**
 * I suppose LB stays for Lower Bound but...
 */
public class AprioriWithLB implements AlgoLayout {
    private static final Logger logger = Logger.getLogger(AprioriWithLB.class);
...
//	clique_miner = new EagerCliqueMiner(K, M, L, G);
    ...
    public JavaRDD<IntSet> runLogic() {
        ...
        logger.debug("Total edges from all snapshots:\t" + stage1.count());
        ...
        logger.debug("[LOAD SCHEDULE]: " + (time_end - time_start) + " ms");
