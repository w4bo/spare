...
/**
 * Edges with cardinality less than K is not an appropriate pattern.
 * In fact, edges which is not a pattern in the first place should not be of part of a
 * pattern in subsequent mining
 * THIS IS THE G_STEP of the SEQUENCE SIMPLIFICATION.
 *
 * @author a0048267
 */
public class EdgeFilter implements Function<Tuple2<Tuple2<Integer, Integer>, IntSortedSet>, Boolean> {
    ...
    @Override
    public Boolean call(Tuple2<Tuple2<Integer, Integer>, IntSortedSet> v1) throws Exception {
        return v1._2.size() >= K;
    }
}
