 ...
 * Input of the clustering process phase.
 *
 * @author a0048267
 */
public class SnapShot implements Serializable {
    ...
    public void MergeWith(SnapShot sp) {
        if (sp.timestamp != timestamp) {
            System.err.println("[ERR]: cannot merge Snapshots with different timestamps, expect " + timestamp + " , merged with " + sp.timestamp);
        } else {
