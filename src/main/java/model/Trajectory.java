...
public class Trajectory extends ArrayList<TemporalPoint> {
     ...
     * rejected.
     * 
     * @param tp th temporal point to be added
     * @return true if the point has been correctly inserted, false otherwise.
     */
     ...
     * 
     * @return an integer containing the length.
     */
