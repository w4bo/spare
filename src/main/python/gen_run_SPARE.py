...
datasets = [
    ...
    Template("ctm.tmp_transactiontable__tbl_${table}__lmt_1000000__size_${minsize}__sup_${minsup}__bins_${bins}__ts_${timescale}__bint_${bint}")
